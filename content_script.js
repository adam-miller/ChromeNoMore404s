...
//old message passing code
//chrome.runtime.sendMessage({wayback: "isAvailable"}, function(response) {
//if(!response)
//console.log("background doesn't exist");
//else {
//console.log(response);
//console.log(response.archived_snapshots);
//}
//});
